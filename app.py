...
def create_catalog_charts(catalog_df, selected_catalog_year):
    ...
    with col1:
        st.markdown("""
        <div style='background: rgba(255,255,255,0.85); padding: 20px; border-radius: 10px; border: 1px solid rgba(255,255,255,0.5); text-align: center; backdrop-filter: blur(5px);'>
