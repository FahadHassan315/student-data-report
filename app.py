...
def login_page():
    st.set_page_config(page_title="🔐 Login - Hafali Smart Solution", layout="centered")
    
    st.markdown("""
    <div style="text-align: center; padding: 2rem;">
        <h1>🔐 Hafali Smart Solution</h1>
...
def main_app():
    # Page setup
    st.set_page_config(page_title="📊 Hafali Smart Solution", layout="wide")
    
    # Header with logout
    col1, col2 = st.columns([3, 1])
    with col1:
        st.title("📊 Hafali Smart Solution")
    with col2:
